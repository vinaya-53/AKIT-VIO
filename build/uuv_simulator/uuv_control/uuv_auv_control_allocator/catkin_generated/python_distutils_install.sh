...
echo_and_run cd "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_auv_control_allocator"
...
echo_and_run /usr/bin/env \
    ...
    "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_auv_control_allocator/setup.py" \
     \
    build --build-base "/home/svg/uuv_ws/build/uuv_simulator/uuv_control/uuv_auv_control_allocator" \
    install \
    --root="${DESTDIR-/}" \
