...
echo_and_run cd "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_trajectory_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_trajectory_control/setup.py" \
     \
    build --build-base "/home/svg/uuv_ws/build/uuv_simulator/uuv_control/uuv_trajectory_control" \
    install \
    --root="${DESTDIR-/}" \
