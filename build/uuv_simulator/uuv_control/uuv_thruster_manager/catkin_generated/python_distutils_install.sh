...
echo_and_run cd "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/home/svg/uuv_ws/src/uuv_simulator/uuv_control/uuv_thruster_manager/setup.py" \
     \
    build --build-base "/home/svg/uuv_ws/build/uuv_simulator/uuv_control/uuv_thruster_manager" \
    install \
    --root="${DESTDIR-/}" \
