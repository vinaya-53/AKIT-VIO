  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uuv_control_msgs::GetMBSMControllerParamsResponse_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.lambda.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.lambda[i]);
    }
    if (v.lambda.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "rho_constant: ";
    if (v.rho_constant.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.rho_constant.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.rho_constant[i]);
    }
    if (v.rho_constant.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.k.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.k[i]);
    }
    if (v.k.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.c.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.c[i]);
    }
    if (v.c.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "adapt_slope: ";
    if (v.adapt_slope.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.adapt_slope.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.adapt_slope[i]);
    }
    if (v.adapt_slope.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.rho_0.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.rho_0[i]);
    }
    if (v.rho_0.empty() || true)
      s << "]";
    if (true || !indent.empty())
