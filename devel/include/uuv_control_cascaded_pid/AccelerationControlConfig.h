...
namespace uuv_control
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(AccelerationControlConfig &config, const AccelerationControlConfig &max, const AccelerationControlConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const AccelerationControlConfig &config1, const AccelerationControlConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, AccelerationControlConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const AccelerationControlConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, AccelerationControlConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const AccelerationControlConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const AccelerationControlConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, AccelerationControlConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
